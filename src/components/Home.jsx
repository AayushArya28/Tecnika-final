...
const Home = ({ logged }) => {
  ...
  return (
    <section className="relative overflow-hidden container mx-auto min-h-screen lg:min-h-[1200px] p-4 flex flex-col justify-start bg-black">
      <div className="flex flex-col justify-center items-center text-center relative z-10 mt-12 sm:mt-24">
