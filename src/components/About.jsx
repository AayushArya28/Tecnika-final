      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 pb-16">
          ...
          <div className="text-center py-20">
            <h1 className="text-5xl font-bold text-white mb-6 text-center  font-Default">About Technika</h1>
            <p className="text-2xl text-gray-200 max-w-3xl mx-auto font-Default">
          ...
          <div className="w-full md:w-[85%] lg:w-[70%] mx-auto mt-10 space-y-12">
            {/* Card 1 */}
            <div className="bg-white p-8 md:p-12 shadow-lg  border-2 border-gray-100">
              <h2 className="text-3xl font-semibold text-center text-indigo-600 font-Default">Welcome to Technika</h2>
              <p className="mt-6 text-gray-700 text-lg leading-relaxed font-Default">
            ...
            {/* Card 2 */}
            <div className="bg-white p-8 md:p-12 shadow-lg  border-2 border-gray-100">
              <h2 className="text-3xl font-semibold text-center text-indigo-600 font-Default">Cultural Extravaganza</h2>
              <p className="mt-6 text-gray-700 text-lg leading-relaxed font-Default">
            ...
            {/* Card 3 */}
            <div className="bg-white p-8 md:p-12 shadow-lg  border-2 border-gray-100">
              <h2 className="text-3xl font-semibold text-center text-indigo-600 font-Default">Join Us at Technika!</h2>
              <p className="mt-6 text-gray-700 text-lg leading-relaxed font-Default">
