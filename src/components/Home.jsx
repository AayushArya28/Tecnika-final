      ...
      <div className="flex flex-col justify-center items-center text-center relative z-10 mt-24 sm:mt-24">
        <section className="text-primary flex flex-col justify-center items-center font-Default">
          <Bounce triggerOnce={true} delay={200}>
            <p className="text-sm sm:text-lg md:text-2xl tracking-wider sm:tracking-widest md:tracking-[0.8rem] font-Default mb-4 text-white font-bold">
              26-28th October
            </p>
          </Bounce>
          ...
          <Bounce triggerOnce={true} direction="up" delay={800}>
            <p className="text-base sm:text-2xl md:text-4xl tracking-normal sm:tracking-wider md:tracking-widest font-bold text-[#ceffd1] font-Default mt-4 animate-pulse">
